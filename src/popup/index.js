...
function setCaptureButtonLoading(isLoading) {
  ...
  dom.btnCapture.innerHTML = isLoading
    ? `<span class="loader"></span> ${escapeHtml(t("popup.captureInProgress"))}`
    : `<span class="btn-icon">📸</span><span>${escapeHtml(t("popup.captureNow"))}</span>`;
}
